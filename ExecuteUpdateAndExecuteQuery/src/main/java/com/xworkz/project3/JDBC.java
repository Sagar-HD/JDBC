...
public class JDBC {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        try{
            ...
            String insertQuery="insert into payment (from_account,to_account,amount) values ('123','678',1000)";
            String updateQuery="update payment set amount=100 where from_account=123 ";
            String selectQuery="select * from payment where from_account=123";
            String deleteQuery="delete from payment where from_account=123";
